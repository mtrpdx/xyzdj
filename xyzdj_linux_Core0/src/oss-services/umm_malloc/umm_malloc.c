...
#ifdef FREE_RTOS
SemaphoreHandle_t umm_heap_locks[UMM_NUM_HEAPS];
#endif
...
#include "umm_integrity.c_"
#include "umm_poison.c_"
#include "umm_info.c_"
...
#ifdef FREE_RTOS
  /* Initialize a lock for the heap */
  umm_heap_locks[HEAP_TYPE] = xSemaphoreCreateRecursiveMutex();
#endif
